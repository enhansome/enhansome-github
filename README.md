...
收集这个[awesome-github](https://github.com/AntBranch/awesome-github) ⭐ 2,175 | 🐛 4 | 📅 2026-03-12列表，只是为了更好地使用亲爱的GitHub,欢迎提交pr和issue。
...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,846 | 🐛 77 | 📅 2026-09-11 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 59,164 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,212 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
* [Github全程指南-如何高效使用？](https://github.com/xirong/my-git/blob/master/how-to-use-github.md) ⭐ 7,396 | 🐛 6 | 🌐 HTML | 📅 2026-09-09 - 作为一名开发者，Github上面有很多东西值得关注学习，可是刚刚接触github，怎样一步步学习使用Github？怎样更高效的利用Github？
...
* [git-history](https://github.com/pomber/git-history) ⭐ 13,683 | 🐛 94 | 🌐 JavaScript | 📅 2024-10-10 - 这个工具可以非常形象地展示某个文件的提交历史，包括提交开发者的信息和时间，提交后文件的内容。
...
* [CODELF](http://unbug.github.io/codelf/) - 基于Google Lovefiled，简洁快速，从开发者角度考虑，用完就走，不给开发者更多的管理负担。开源在GitHub上的链接[unbug/codelf](https://github.com/unbug/codelf) ⭐ 14,133 | 🐛 43 | 🌐 JavaScript | 📅 2025-06-06
...
* [primer](https://github.com/primer/primer) ⭐ 13,020 | 🐛 6 | 🌐 SCSS | 📅 2026-09-18 -Primer 是 Github 工具包，用于 Github 前端设计。
* [octicons](https://github.com/github/octicons) ⭐ 8,757 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - GitHub的 图标字体
...
* [gitee](https://github.com/Nightonke/Gitee) ⭐ 1,118 | 🐛 14 | 🌐 Swift | 📅 2017-10-12 - Gitee, OS X status bar application for Github 漂亮的GitHub数据统计工具，还有notifications功能
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,187 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-19 - chrome插件，简化你的github，增加了一些可用的功能
...
* [git](https://github.com/git/git) ⭐ 63,246 | 🐛 394 | 🌐 C | 📅 2026-09-17 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,080 | 🐛 2,463 | 🌐 Go | 📅 2026-09-20 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
...
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,546 | 🐛 36 | 🌐 Ruby | 📅 2026-09-20
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,121 | 🐛 359 | 🌐 Objective-C | 📅 2026-09-18 - Objective-C编写的Mac上的Git客户端
* [gitbucket](https://github.com/gitbucket/gitbucket) ⭐ 9,404 | 🐛 331 | 🌐 Scala | 📅 2026-09-20 - Scala编写的开源Git平台，扩展性好，兼容GitHub
...
* [resume.github.com](https://github.com/resume/resume.github.com) ⭐ 62,887 | 🐛 77 | 🌐 JavaScript | 📅 2023-02-15 - 根据用户的github信息生成简历
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,048 | 🐛 57 | 🌐 JavaScript | 📅 2026-09-19 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,978 | 🐛 54 | 🌐 CSS | 📅 2026-09-17 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,923 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [githug](https://github.com/Gazler/githug) ⭐ 6,950 | 🐛 48 | 🌐 Shell | 📅 2026-09-14 - 通过游戏的方式来练习Git的命令行工具
...
* [git-changelog-lib](https://github.com/tomasbjerre/git-changelog-lib) ⭐ 218 | 🐛 0 | 🌐 Java | 📅 2026-09-19 - 解析和生成changelog，releasenotes的库
...
* [go-github](https://github.com/google/go-github) ⭐ 11,308 | 🐛 36 | 🌐 Go | 📅 2026-09-19 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,599 | 🐛 545 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,777 | 🐛 407 | 🌐 Python | 📅 2026-09-09 - Python的GitHub API封装库
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,777 | 🐛 407 | 🌐 Python | 📅 2026-09-09 - GitHub API v3的python接口
* [github - Haskell](https://github.com/PyGithub/PyGithub) ⭐ 7,777 | 🐛 407 | 🌐 Python | 📅 2026-09-09 - GitHub API 的Haskell接口
* [nodegit](https://github.com/nodegit/nodegit) ⭐ 5,750 | 🐛 364 | 🌐 JavaScript | 📅 2026-07-16 - git的node实现
...
* [pygit2](https://github.com/libgit2/pygit2) ⭐ 1,729 | 🐛 189 | 🌐 Python | 📅 2026-09-19 - libgit2的python版
...
* [ruby-github](https://github.com/peter-murach/github) ⭐ 1,200 | 🐛 29 | 🌐 Ruby | 📅 2023-05-13 -Ruby实现的GitHub API库
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,164 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
...
谢谢所有的[贡献者](https://github.com/AntBranch/awesome-github/graphs/contributors) ⭐ 2,175 | 🐛 4 | 📅 2026-03-12.
