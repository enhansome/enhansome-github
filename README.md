...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,798 | 🐛 75 | 📅 2026-09-11 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 59,107 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,209 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
...
* [git-tips](https://github.com/git-tips/tips) ⭐ 21,723 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-17 - 最常用的Git的提示和技巧。
...
* [Hexo](https://github.com/hexojs/hexo) ⭐ 41,771 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-29 - 通过Github Pages写博客的Node.js框架
* [primer](https://github.com/primer/primer) ⭐ 13,018 | 🐛 8 | 🌐 SCSS | 📅 2026-09-16 -Primer 是 Github 工具包，用于 Github 前端设计。
* [octicons](https://github.com/github/octicons) ⭐ 8,755 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-16 - GitHub的 图标字体
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,173 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-16 - chrome插件，简化你的github，增加了一些可用的功能
...
* [git-town](https://github.com/Originate/git-town) ⭐ 3,373 | 🐛 52 | 🌐 Gherkin | 📅 2026-09-14
...
* [git](https://github.com/git/git) ⭐ 63,183 | 🐛 390 | 🌐 C | 📅 2026-09-16 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,034 | 🐛 2,458 | 🌐 Go | 📅 2026-09-17 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,818 | 🐛 1,014 | 🌐 Go | 📅 2026-09-12 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,543 | 🐛 36 | 🌐 Ruby | 📅 2026-09-17
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,119 | 🐛 358 | 🌐 Objective-C | 📅 2026-09-16 - Objective-C编写的Mac上的Git客户端
* [gitbucket](https://github.com/gitbucket/gitbucket) ⭐ 9,405 | 🐛 332 | 🌐 Scala | 📅 2026-09-16 - Scala编写的开源Git平台，扩展性好，兼容GitHub
...
* [resume.github.com](https://github.com/resume/resume.github.com) ⭐ 62,891 | 🐛 77 | 🌐 JavaScript | 📅 2023-02-15 - 根据用户的github信息生成简历
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,038 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-12 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,977 | 🐛 54 | 🌐 CSS | 📅 2026-09-17 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,915 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [git-changelog-lib](https://github.com/tomasbjerre/git-changelog-lib) ⭐ 218 | 🐛 0 | 🌐 Java | 📅 2026-09-16 - 解析和生成changelog，releasenotes的库
...
* [go-github](https://github.com/google/go-github) ⭐ 11,309 | 🐛 41 | 🌐 Go | 📅 2026-09-16 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,596 | 🐛 539 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,775 | 🐛 406 | 🌐 Python | 📅 2026-09-09 - Python的GitHub API封装库
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,775 | 🐛 406 | 🌐 Python | 📅 2026-09-09 - GitHub API v3的python接口
* [github - Haskell](https://github.com/PyGithub/PyGithub) ⭐ 7,775 | 🐛 406 | 🌐 Python | 📅 2026-09-09 - GitHub API 的Haskell接口
* [nodegit](https://github.com/nodegit/nodegit) ⭐ 5,750 | 🐛 363 | 🌐 JavaScript | 📅 2026-07-16 - git的node实现
* [github - michael](https://github.com/michael/github) ⭐ 3,755 | 🐛 213 | 🌐 JavaScript | 📅 2022-09-04 - JavaScript写的GitHub API的封装库
...
* [pygit2](https://github.com/libgit2/pygit2) ⭐ 1,728 | 🐛 190 | 🌐 Python | 📅 2026-09-15 - libgit2的python版
* [git.js](https://github.com/danlucraft/git.js) ⭐ 1,303 | 🐛 6 | 🌐 JavaScript | 📅 2019-02-28 - git的js实现
* [github3.py](https://github.com/sigmavirus24/github3.py) ⭐ 1,258 | 🐛 74 | 🌐 Python | 📅 2026-08-31 - GitHub API v3的python接口
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,107 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
* [awesome-browser-extensions-for-github](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,302 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18 -GitHub浏览器扩展收集列表
