...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,355 | 🐛 83 | 📅 2026-07-23 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 58,566 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,142 | 🐛 7 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
* [Github全程指南-如何高效使用？](https://github.com/xirong/my-git/blob/master/how-to-use-github.md) ⭐ 7,399 | 🐛 6 | 🌐 Python | 📅 2026-06-11 - 作为一名开发者，Github上面有很多东西值得关注学习，可是刚刚接触github，怎样一步步学习使用Github？怎样更高效的利用Github？
* [Github MarkDown语法指南](https://github.com/guodongxiaren/README) ⭐ 7,056 | 🐛 54 | 📅 2025-11-24 - 使用Github必备
* [learn-with-open-source](https://github.com/zhuangbiaowei/learn-with-open-source) ⭐ 1,760 | 🐛 8 | 🌐 Shell | 📅 2022-05-16 - 开放文档：《借助开源项目，学习软件开发》
...
* [learn-travis](https://github.com/dwyl/learn-travis) ⭐ 1,228 | 🐛 1 | 🌐 JavaScript | 📅 2022-03-24 - 一个对于node.js开发者快速入门的教程
...
* [git-history](https://github.com/pomber/git-history) ⭐ 13,689 | 🐛 94 | 🌐 JavaScript | 📅 2024-10-10 - 这个工具可以非常形象地展示某个文件的提交历史，包括提交开发者的信息和时间，提交后文件的内容。
...
* [CODELF](http://unbug.github.io/codelf/) - 基于Google Lovefiled，简洁快速，从开发者角度考虑，用完就走，不给开发者更多的管理负担。开源在GitHub上的链接[unbug/codelf](https://github.com/unbug/codelf) ⭐ 14,146 | 🐛 43 | 🌐 JavaScript | 📅 2025-06-06
...
* [primer](https://github.com/primer/primer) ⭐ 13,001 | 🐛 5 | 🌐 SCSS | 📅 2026-08-17 -Primer 是 Github 工具包，用于 Github 前端设计。
* [octicons](https://github.com/github/octicons) ⭐ 8,740 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-11 - GitHub的 图标字体
...
* [backup-utils](https://github.com/github/backup-utils) ⭐ 1,270 | 🐛 0 | 📅 2026-06-30 - backup-utils 是 Github 企业备份工具，它包括一些备份和恢复工具。这些备份工具实现了多项用于备份主机的高级功能，还原功能也已经包括在 GitHub Enterprise 中。
...
* [MVVMReactiveCocoa](https://github.com/leichunfeng/MVVMReactiveCocoa) ⭐ 3,689 | 🐛 42 | 🌐 Objective-C | 📅 2018-02-05 [![GitHub stars](https://img.shields.io/github/stars/leichunfeng/MVVMReactiveCocoa.svg)]() - GitBucket iOS App，一个GitHub第三方客户端
...
* [ForkHub](https://github.com/jonan/ForkHub) ⭐ 2,797 | 🐛 148 | 🌐 JavaScript | 📅 2022-03-19 [![GitHub stars](https://img.shields.io/github/stars/jonan/ForkHub.svg)]() - Android平台的GitHub客户端
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 31,943 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-15 - chrome插件，简化你的github，增加了一些可用的功能
* [octotree](https://github.com/buunguyen/octotree) ⭐ 23,232 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 -浏览器扩展，树状格式显示GitHub的代码
...
* [alfred-github-workflow](https://github.com/gharlan/alfred-github-workflow) ⭐ 2,919 | 🐛 10 | 🌐 PHP | 📅 2026-05-10 - Alfred 2上使用GitHub命令
...
* [notifier-for-github-chrome](https://github.com/sindresorhus/notifier-for-github-chrome) ⭐ 1,982 | 🐛 26 | 🌐 JavaScript | 📅 2025-06-25 - 一个浏览器扩展，它能显示 Github 通知的未读数量
* [github-hovercard](https://github.com/Justineo/github-hovercard) ⭐ 1,894 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-15 - GitHub Hovercard 是一个浏览器扩展，实现了展示用户在 Github 上信息的信息卡功能，支持 Firefox 和 Chrome 浏览器。
...
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,700 | 🐛 21 | 🌐 Shell | 📅 2023-12-04 - 吐槽别人的烂代码
* [gitsome](https://github.com/donnemartin/gitsome/) ⭐ 7,682 | 🐛 66 | 🌐 Python | 📅 2024-02-08 - supercharged Github Client
* [gitsome](https://github.com/donnemartin/gitsome) ⭐ 7,682 | 🐛 66 | 🌐 Python | 📅 2024-02-08 - Git/GitHub命令行工具
...
* [git-town](https://github.com/Originate/git-town) ⭐ 3,363 | 🐛 45 | 🌐 Gherkin | 📅 2026-07-26
...
* [git](https://github.com/git/git) ⭐ 62,615 | 🐛 388 | 🌐 C | 📅 2026-08-17 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,456 | 🐛 2,537 | 🌐 Go | 📅 2026-08-17 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,733 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,533 | 🐛 37 | 🌐 Ruby | 📅 2026-08-18
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,098 | 🐛 364 | 🌐 Objective-C | 📅 2026-07-27 - Objective-C编写的Mac上的Git客户端
* [gitbucket](https://github.com/gitbucket/gitbucket) ⭐ 9,389 | 🐛 331 | 🌐 Scala | 📅 2026-08-14 - Scala编写的开源Git平台，扩展性好，兼容GitHub
...
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 33,888 | 🐛 60 | 🌐 JavaScript | 📅 2026-08-18 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,941 | 🐛 55 | 🌐 CSS | 📅 2026-08-14 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,855 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
* [gitfiti](https://github.com/gelstudios/gitfiti) ⭐ 8,441 | 🐛 17 | 🌐 Python | 📅 2024-10-28 - 滥用github提交历史
* [gitalk](https://github.com/gitalk/gitalk) ⭐ 7,170 | 🐛 155 | 🌐 JavaScript | 📅 2026-07-05 - Gitalk 是一个基于 Github Issue 和 Preact 开发的评论插件。
* [githug](https://github.com/Gazler/githug) ⭐ 6,951 | 🐛 48 | 🌐 Shell | 📅 2024-08-11 - 通过游戏的方式来练习Git的命令行工具
* [github-corners](https://github.com/tholman/github-corners) ⭐ 4,995 | 🐛 17 | 🌐 HTML | 📅 2025-01-01 - 显示 "Fork me on GitHub"
...
* [GitHub Archive](https://github.com/igrigorik/githubarchive.org) ⭐ 3,068 | 🐛 36 | 🌐 Ruby | 📅 2025-05-25 - GitHub Archive 是一个记录GitHub时间线的项目
...
* [go-github](https://github.com/google/go-github) ⭐ 11,277 | 🐛 33 | 🌐 Go | 📅 2026-08-13 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,561 | 🐛 519 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,756 | 🐛 409 | 🌐 Python | 📅 2026-08-17 - Python的GitHub API封装库
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,756 | 🐛 409 | 🌐 Python | 📅 2026-08-17 - GitHub API v3的python接口
* [github - Haskell](https://github.com/PyGithub/PyGithub) ⭐ 7,756 | 🐛 409 | 🌐 Python | 📅 2026-08-17 - GitHub API 的Haskell接口
* [nodegit](https://github.com/nodegit/nodegit) ⭐ 5,754 | 🐛 363 | 🌐 JavaScript | 📅 2026-07-16 - git的node实现
...
* [php-github-api](https://github.com/KnpLabs/php-github-api) ⭐ 2,203 | 🐛 53 | 🌐 PHP | 📅 2026-03-16 - php的github api
...
* [github3.py](https://github.com/sigmavirus24/github3.py) ⭐ 1,256 | 🐛 74 | 🌐 Python | 📅 2026-08-17 - GitHub API v3的python接口
...
* [GitSharp](https://github.com/henon/GitSharp) ⭐ 664 | 🐛 0 | 🌐 C# | 📅 2020-11-02 - .Net实现的git
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,566 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
* [awesome-browser-extensions-for-github](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,287 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18 -GitHub浏览器扩展收集列表
