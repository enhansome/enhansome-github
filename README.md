...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,541 | 🐛 84 | 📅 2026-09-01 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 58,827 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,168 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
...
* [git-history](https://github.com/pomber/git-history) ⭐ 13,690 | 🐛 94 | 🌐 JavaScript | 📅 2024-10-10 - 这个工具可以非常形象地展示某个文件的提交历史，包括提交开发者的信息和时间，提交后文件的内容。
...
* [Hexo](https://github.com/hexojs/hexo) ⭐ 41,772 | 🐛 74 | 🌐 TypeScript | 📅 2026-08-29 - 通过Github Pages写博客的Node.js框架
* [primer](https://github.com/primer/primer) ⭐ 13,012 | 🐛 7 | 🌐 SCSS | 📅 2026-09-02 -Primer 是 Github 工具包，用于 Github 前端设计。
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,021 | 🐛 69 | 🌐 TypeScript | 📅 2026-09-01 - chrome插件，简化你的github，增加了一些可用的功能
...
* [github-oauth-plugin](https://github.com/jenkinsci/github-oauth-plugin) ⭐ 104 | 🐛 10 | 🌐 Java | 📅 2026-09-01 - jenkins的github oauth登录插件
...
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,704 | 🐛 21 | 🌐 Shell | 📅 2023-12-04 - 吐槽别人的烂代码
...
* [git](https://github.com/git/git) ⭐ 62,943 | 🐛 387 | 🌐 C | 📅 2026-09-01 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,761 | 🐛 2,529 | 🌐 Go | 📅 2026-09-02 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,788 | 🐛 1,011 | 🌐 Go | 📅 2026-08-26 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,546 | 🐛 36 | 🌐 Ruby | 📅 2026-09-02
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,115 | 🐛 366 | 🌐 Objective-C | 📅 2026-07-27 - Objective-C编写的Mac上的Git客户端
...
* [resume.github.com](https://github.com/resume/resume.github.com) ⭐ 62,889 | 🐛 76 | 🌐 JavaScript | 📅 2023-02-15 - 根据用户的github信息生成简历
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 33,984 | 🐛 61 | 🌐 JavaScript | 📅 2026-09-01 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,971 | 🐛 54 | 🌐 CSS | 📅 2026-09-01 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,888 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [lolcommits](https://github.com/mroth/lolcommits) ⭐ 4,818 | 🐛 40 | 🌐 Ruby | 📅 2026-09-01 - 每次提交Git都自拍一张
...
* [go-github](https://github.com/google/go-github) ⭐ 11,290 | 🐛 37 | 🌐 Go | 📅 2026-08-29 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,580 | 🐛 529 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,767 | 🐛 400 | 🌐 Python | 📅 2026-08-27 - Python的GitHub API封装库
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,767 | 🐛 400 | 🌐 Python | 📅 2026-08-27 - GitHub API v3的python接口
* [github - Haskell](https://github.com/PyGithub/PyGithub) ⭐ 7,767 | 🐛 400 | 🌐 Python | 📅 2026-08-27 - GitHub API 的Haskell接口
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,827 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
