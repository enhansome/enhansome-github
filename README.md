...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,817 | 🐛 75 | 📅 2026-09-11 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 59,128 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,211 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
...
* [Hexo](https://github.com/hexojs/hexo) ⭐ 41,774 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-29 - 通过Github Pages写博客的Node.js框架
* [primer](https://github.com/primer/primer) ⭐ 13,018 | 🐛 6 | 🌐 SCSS | 📅 2026-09-17 -Primer 是 Github 工具包，用于 Github 前端设计。
* [octicons](https://github.com/github/octicons) ⭐ 8,756 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - GitHub的 图标字体
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,178 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-17 - chrome插件，简化你的github，增加了一些可用的功能
...
* [hub](https://github.com/github/hub) ⭐ 22,954 | 🐛 296 | 🌐 Go | 📅 2024-02-02 - github官方出品的命令行工具，让你更好地使用github
...
* [git-town](https://github.com/Originate/git-town) ⭐ 3,375 | 🐛 52 | 🌐 Gherkin | 📅 2026-09-14
...
* [git](https://github.com/git/git) ⭐ 63,208 | 🐛 392 | 🌐 C | 📅 2026-09-17 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 58,053 | 🐛 2,464 | 🌐 Go | 📅 2026-09-18 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,819 | 🐛 1,014 | 🌐 Go | 📅 2026-09-12 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,545 | 🐛 36 | 🌐 Ruby | 📅 2026-09-18
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,120 | 🐛 358 | 🌐 Objective-C | 📅 2026-09-18 - Objective-C编写的Mac上的Git客户端
...
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,044 | 🐛 56 | 🌐 JavaScript | 📅 2026-09-17 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,976 | 🐛 54 | 🌐 CSS | 📅 2026-09-17 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,918 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [go-github](https://github.com/google/go-github) ⭐ 11,307 | 🐛 40 | 🌐 Go | 📅 2026-09-17 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,596 | 🐛 543 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
...
* [github - michael](https://github.com/michael/github) ⭐ 3,756 | 🐛 213 | 🌐 JavaScript | 📅 2022-09-04 - JavaScript写的GitHub API的封装库
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,128 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
...
* [awesome-github-templates](https://github.com/devspace/awesome-github-templates) ⭐ 2,318 | 🐛 12 | 📅 2023-07-03 - github issue 和 pull request的模版列表
