...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,682 | 🐛 74 | 📅 2026-09-08 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 58,968 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,192 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
...
* [CODELF](http://unbug.github.io/codelf/) - 基于Google Lovefiled，简洁快速，从开发者角度考虑，用完就走，不给开发者更多的管理负担。开源在GitHub上的链接[unbug/codelf](https://github.com/unbug/codelf) ⭐ 14,138 | 🐛 43 | 🌐 JavaScript | 📅 2025-06-06
...
* [primer](https://github.com/primer/primer) ⭐ 13,016 | 🐛 11 | 🌐 SCSS | 📅 2026-09-09 -Primer 是 Github 工具包，用于 Github 前端设计。
* [octicons](https://github.com/github/octicons) ⭐ 8,750 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-09 - GitHub的 图标字体
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,102 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-09 - chrome插件，简化你的github，增加了一些可用的功能
* [octotree](https://github.com/buunguyen/octotree) ⭐ 23,244 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 -浏览器扩展，树状格式显示GitHub的代码
...
* [git-plugin](https://github.com/jenkinsci/git-plugin) ⭐ 694 | 🐛 513 | 🌐 Java | 📅 2026-09-07 - jenkins的git插件
...
* [hub](https://github.com/github/hub) ⭐ 22,954 | 🐛 295 | 🌐 Go | 📅 2024-02-02 - github官方出品的命令行工具，让你更好地使用github
...
* [git](https://github.com/git/git) ⭐ 63,093 | 🐛 388 | 🌐 C | 📅 2026-09-09 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,919 | 🐛 2,456 | 🌐 Go | 📅 2026-09-10 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,802 | 🐛 1,010 | 🌐 Go | 📅 2026-09-06 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,538 | 🐛 36 | 🌐 Ruby | 📅 2026-09-10
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,119 | 🐛 366 | 🌐 Objective-C | 📅 2026-07-27 - Objective-C编写的Mac上的Git客户端
...
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,018 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-10 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,975 | 🐛 54 | 🌐 CSS | 📅 2026-09-08 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,899 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [go-github](https://github.com/google/go-github) ⭐ 11,299 | 🐛 44 | 🌐 Go | 📅 2026-09-08 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,588 | 🐛 535 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,772 | 🐛 404 | 🌐 Python | 📅 2026-09-09 - Python的GitHub API封装库
* [PyGithub](https://github.com/PyGithub/PyGithub) ⭐ 7,772 | 🐛 404 | 🌐 Python | 📅 2026-09-09 - GitHub API v3的python接口
* [github - Haskell](https://github.com/PyGithub/PyGithub) ⭐ 7,772 | 🐛 404 | 🌐 Python | 📅 2026-09-09 - GitHub API 的Haskell接口
* [nodegit](https://github.com/nodegit/nodegit) ⭐ 5,750 | 🐛 363 | 🌐 JavaScript | 📅 2026-07-16 - git的node实现
* [github - michael](https://github.com/michael/github) ⭐ 3,751 | 🐛 212 | 🌐 JavaScript | 📅 2022-09-04 - JavaScript写的GitHub API的封装库
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 58,968 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
* [awesome-browser-extensions-for-github](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,299 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18 -GitHub浏览器扩展收集列表
