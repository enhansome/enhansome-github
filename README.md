...
* [gitignore](https://github.com/github/gitignore) ⭐ 175,764 | 🐛 73 | 📅 2026-09-11 - GitHub官方的.gitignore模板集合
* [GitHub 秘籍](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.zh-cn.md) ⭐ 59,040 | 🐛 48 | 📅 2024-04-15 - 本书为 Github 中级教程，适用在 Github 上做开源项目、制作自己的博客和协同做项目的开发者。
* [GitHub 漫游指南](https://github.com/phodal/github-roam) ⭐ 11,200 | 🐛 0 | 🌐 Rich Text Format | 📅 2024-08-24 - phodal的GitHub故事与教程
...
* [CODELF](http://unbug.github.io/codelf/) - 基于Google Lovefiled，简洁快速，从开发者角度考虑，用完就走，不给开发者更多的管理负担。开源在GitHub上的链接[unbug/codelf](https://github.com/unbug/codelf) ⭐ 14,135 | 🐛 43 | 🌐 JavaScript | 📅 2025-06-06
...
* [octicons](https://github.com/github/octicons) ⭐ 8,754 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-11 - GitHub的 图标字体
...
* [refined-github](https://github.com/sindresorhus/refined-github) ⭐ 32,154 | 🐛 79 | 🌐 TypeScript | 📅 2026-09-12 - chrome插件，简化你的github，增加了一些可用的功能
...
* [git-town](https://github.com/Originate/git-town) ⭐ 3,372 | 🐛 52 | 🌐 Gherkin | 📅 2026-09-12
...
* [git](https://github.com/git/git) ⭐ 63,143 | 🐛 390 | 🌐 C | 📅 2026-09-13 - git源码
* [gitea](https://github.com/go-gitea/gitea) ⭐ 57,970 | 🐛 2,460 | 🌐 Go | 📅 2026-09-14 - Gitea的首要目标是创建一个极易安装，运行非常快速，安装和使用体验良好的自建 Git 服务。
* [gogs](https://github.com/gogits/gogs) ⭐ 47,810 | 🐛 1,014 | 🌐 Go | 📅 2026-09-12 - Gogs (Go Git Service) 是一款极易搭建的自助 Git 服务，由[无闻](https://github.com/Unknwon)编写并开源在GitHub。
* [gitlab](https://about.gitlab.com/gitlab-com/) - GitLab 是一个用于仓库管理系统的开源项目，地址在[gitlabhq](https://github.com/gitlabhq/gitlabhq) ⭐ 24,540 | 🐛 36 | 🌐 Ruby | 📅 2026-09-14
* [GitUp](https://github.com/git-up/GitUp) ⭐ 12,119 | 🐛 367 | 🌐 Objective-C | 📅 2026-07-27 - Objective-C编写的Mac上的Git客户端
* [gitbucket](https://github.com/gitbucket/gitbucket) ⭐ 9,404 | 🐛 332 | 🌐 Scala | 📅 2026-09-08 - Scala编写的开源Git平台，扩展性好，兼容GitHub
...
* [learnGitBranching](https://github.com/pcottle/learnGitBranching) ⭐ 34,024 | 🐛 60 | 🌐 JavaScript | 📅 2026-09-12 - 学习git的可视化工具
* [GitHub-Dark](https://github.com/StylishThemes/GitHub-Dark) ⭐ 9,976 | 🐛 54 | 🌐 CSS | 📅 2026-09-11 - 黑色的GitHub网站风格
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,908 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - git加密
...
* [githug](https://github.com/Gazler/githug) ⭐ 6,952 | 🐛 49 | 🌐 Shell | 📅 2024-08-11 - 通过游戏的方式来练习Git的命令行工具
...
* [GitHub Archive](https://github.com/igrigorik/githubarchive.org) ⭐ 3,077 | 🐛 37 | 🌐 Ruby | 📅 2025-05-25 - GitHub Archive 是一个记录GitHub时间线的项目
...
* [git-changelog-lib](https://github.com/tomasbjerre/git-changelog-lib) ⭐ 219 | 🐛 24 | 🌐 Java | 📅 2026-09-13 - 解析和生成changelog，releasenotes的库
...
* [go-github](https://github.com/google/go-github) ⭐ 11,309 | 🐛 43 | 🌐 Go | 📅 2026-09-12 -Go实现的GitHub API库
* [libgit2](https://github.com/libgit2/libgit2) ⭐ 10,591 | 🐛 537 | 🌐 C | 📅 2026-08-15 - Git核心库，通过它可以写一个自己的git应用。
...
* [github-cheat-sheet](https://github.com/tiimgreen/github-cheat-sheet) ⭐ 59,040 | 🐛 48 | 📅 2024-04-15 -一些酷酷的Git和GitHub功能收集
